...
namespace TripleG.Server.Controllers
{
    ...
    public class StudentHubController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize(Roles = "Admin,User,Teacher")]
        public async Task<ActionResult<IEnumerable<StudentHub>>> GetStudentHub()
        {
        ...
        [HttpGet("{id}")]
        [Authorize(Roles = "Admin,User,Teacher")]
        public async Task<ActionResult<StudentHub>> GetStudentHub(Guid id)
        {
        ...
        public async Task<IActionResult> PutStudentHub([FromForm] Guid id, StudentHub studentHub)
        {
